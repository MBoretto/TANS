void executeExamNoise(TString myopt="fast"){
  Int_t n = 0;
  Int_t esp = 0;
  Int_t molt = 0;
  Int_t zeta = 0;
  ...
  cin>>scatt;
  //cout<<" -> Attivare il rumore? 1->attivo con molteplicità da distribuzione uniforme, 0->non attivo, n->attivo con molteplicità fissa n su ogni layer : "<<endl;
  //cin>>rhum;
  cout<<endl;
  ...
  if(myopt.Contains("force")){
	...
	gSystem->CompileMacro("AnalizzaNoise.c",opt);
	...
	Trasporta(scatt,rhum,gRandom,100);
